export const dict: Record<string, string[]> = {
  ...
  "max-width: 0px": ["w-0", "w-[0px]"],
  "max-width: 100%": ["w-full"],
  "max-width: 1024px": ["w-5xl", "w-screen-lg", "w-[1024px]"],
  "max-width: 1152px": ["w-6xl", "w-[1152px]"],
  "max-width: 1280px": ["w-7xl", "w-screen-xl", "w-[1280px]"],
  "max-width: 1536px": ["w-screen-2xl", "w-[1536px]"],
  "max-width: 320px": ["w-xs", "w-[320px]"],
  "max-width: 448px": ["w-md", "w-[448px]"],
  "max-width: 512px": ["w-lg", "w-[512px]"],
  "max-width: 576px": ["w-xl", "w-[576px]"],
  "max-width: 640px": ["w-screen-sm", "w-[640px]"],
  "max-width: 65ch": ["w-prose", "w-[65ch]"],
  "max-width: 672px": ["w-2xl", "w-[672px]"],
  "max-width: 768px": ["w-3xl", "w-screen-md", "w-[768px]"],
  "max-width: fit-content": ["w-fit"],
  "max-width: max-content": ["w-max"],
  "max-width: min-content": ["w-min"],
  "max-width: none": ["w-none"],

      ...
      <ul className="mx-auto max-w-[800px] space-y-20 text-lg sm:text-xl">
        <li id="what" className="flex flex-col gap-5 px-2 md:px-0">
          ...
          <p className="text-zinc-400">
            ...
            pieces of CSS, called{" "}
            <span className="text-zinc-200">utilities</span>, which represent a
            single line of CSS.{" "}
          </p>
          <p className="text-zinc-400">
            It encourages <span className="text-zinc-200">colocation</span>{" "}
            (keeping markdown and styles in the same place) for easier
            maintenance. This means you don&apos;t need to worry about naming
            your classes or styles affecting unwanted elements.
          </p>
          <span>
            Read More:{" "}
            <a
              className="items-start gap-2 text-sky-300 underline hover:opacity-80 sm:gap-2"
              target="_blank"
        ...
        <li id="inline" className="flex flex-col gap-5 px-2 md:px-0">
          ...
          <p className="text-zinc-400">
            ...
            <span className="text-zinc-200">state selectors</span> inline.{" "}
          </p>
          <p className="text-zinc-400">
            In Tailwind CSS this is trivial with{" "}
          ...
          <span>
            Read More:{" "}
            <a
              className="text-sky-300 underline hover:opacity-80"
              target="_blank"
              href="https://frontstuff.io/no-utility-classes-arent-the-same-as-inline-styles"
            >
        ...
        <li id="html" className="flex flex-col gap-3 px-2 md:px-0">
          ...
          <p className="text-zinc-400">Yes, it kinda does!</p>{" "}
          <p className="text-zinc-400">
            {" "}
            This is a trade-off that Tailwind CSS embraces: it sacrifices pretty
            HTML for <span className="text-zinc-200">
              styling consistency
            </span>{" "}
            and <span className="text-zinc-200"> ease of maintenance </span>that
